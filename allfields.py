...
plt.plot(ind_t,np.log10(energy_cold),'g.')
plt.plot(ind_t,np.log10(energy_hot),'r.')
plt.plot(ind_t,np.log10(mag_field),'k.')
plt.plot(ind_t,np.log10(energy_thermal),'b',label='thermal energy')
plt.plot(ind_t,np.log10(energy_cold),'g',label='internal energy')
plt.plot(ind_t,np.log10(energy_hot),'r',label='cold energy')
plt.plot(ind_t,np.log10(mag_field),'k',label='magnetic energy')
plt.grid(True)
plt.legend()
plt.xlabel('time')
plt.ylabel('log10 of energy')
...
plt.plot(ind_t,energy_cold,'g',label='internal energy')
plt.plot(ind_t,energy_hot,'r',label='cold energy')
plt.legend()
plt.grid(True)
plt.xlabel('time')
plt.ylabel('energy')
...
plt.clf()
###################3
plt.plot(ind_t,np.log10(mag_field),'b.')
plt.plot(ind_t,np.log10(mag_field),'b')
plt.xlabel('time')
plt.ylabel('total magnetic lof of field energy')
plt.title('time vs log of magfield energy')
plt.grid(True)
